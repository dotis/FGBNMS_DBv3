...
#| column: page
#| layout-nrow: 2
chl_med_img(ERDDAPUrl_chl,field_chl_med,dates2post[8],wlon,slat,elon,nlat)
chl_med_img(ERDDAPUrl_chl,field_chl_med,dates2post[7],wlon,slat,elon,nlat)
chl_med_img(ERDDAPUrl_chl,field_chl_med,dates2post[6],wlon,slat,elon,nlat)
chl_med_img(ERDDAPUrl_chl,field_chl_med,dates2post[5],wlon,slat,elon,nlat)
